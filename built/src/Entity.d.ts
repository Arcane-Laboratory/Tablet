...
export declare abstract class Entity<T extends tableData> implements tableData {
   ...
   */
  static registerEntity<T extends tableData, U extends Entity<T>>(
    this: new (...args: any[]) => U,
    table: Table<T>,
   ...
   */
  static fetch<T extends tableData, U extends Entity<T>>(
    this: new (...args: any[]) => U,
    id: string
  ): Promise<U | null>
  /**
   ...
   */
  static filterEntity<T extends tableData, U extends Entity<T>>(
    this: new (...args: any[]) => U,
   ...
   */
  static findEntity<T extends tableData, U extends Entity<T>>(
    this: new (...args: any[]) => U,
   ...
   */
  static crupdate<T extends tableData, U extends Entity<T>>(
    this: new (...args: any[]) => U,
    record: T
  ): Promise<T | null>
  /**
   ...
   */
  static numCached<T extends tableData>(
    this: new (...args: any[]) => Entity<T>
  ): number
  /**
   * delete a given entity from the table
   */
  static deleteEntry<T extends tableData, U extends Entity<T>>(
    this: new (...args: any[]) => U,
    id: string
  ): Promise<boolean>
  /**
