...
exports.idData = exports.headerTypeMap = exports.PARSABLE_TYPE = exports.SheetData = void 0;
const _tableIndex_1 = require("../tables/_tableIndex");
Object.defineProperty(exports, "headerTypeMap", { enumerable: true, get: function () { return _tableIndex_1.headerTypeMap; } });
Object.defineProperty(exports, "idData", { enumerable: true, get: function () { return _tableIndex_1.idData; } });
Object.defineProperty(exports, "PARSABLE_TYPE", { enumerable: true, get: function () { return _tableIndex_1.PARSABLE_TYPE; } });
...
class SheetData {
    constructor(spreadsheetTitle, table) {
        ...
        this.getAll = () => {
            ...
            this.rows.forEach((row) => {
                try {
                    ...
                    console.log(err);
                    (0, _utilIndex_1.warn)('sheetData', `row ${row.id} skipped in ${this.tabTitle}`);
                }
            });
            return data;
        };
         ...
         */
        this.loadData = async () => {
            this.spreadsheet = spreadsheetLoader_1.spreadsheetList[this.spreadsheetTitle];
            if (!this.spreadsheet)
        ...
        table.headerMap.forEach((type, key) => {
            if (key != 'id')
                this.headerTypeMap.set(key, type);
        });
    }
}
