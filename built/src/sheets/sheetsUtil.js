...
const limiter = new limiter_1.RateLimiter({ tokensPerInterval: 1, interval: 1000 });
...
const load = async (spreadsheetInfo) => {
    const spreadsheet = new google_spreadsheet_1.GoogleSpreadsheet(spreadsheetInfo.spreadsheetId);
