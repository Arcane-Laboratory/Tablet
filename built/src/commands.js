...
exports.entityCache = exports.allEntities = exports.entityList = exports.tableList = exports.tableToString = void 0;
const Entity_1 = require("./Entity");
const Table_1 = require("./Table");
const tableToString = async (tableName) => {
...
const entityCache = (entityName) => {
    const cache = Entity_1.Entity.entityCacheList().find((entity) => entity.ctorName == entityName);
    if (cache === undefined)
        return `no entity cache found with name ${entityName}`;
    return (`${cache.ctorName}: [${cache.cacheSize} entries]\n   ` +
